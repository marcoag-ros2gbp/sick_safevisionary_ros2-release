...
Name:           ros-rolling-sick-safevisionary-interfaces
Version:        1.0.3
Release:        2%{?dist}%{?release_suffix}
Summary:        ROS sick_safevisionary_interfaces package
...
%description
Provides interface descriptions to communicate with a SICK Safevisionary Sensor
over ROS 2
